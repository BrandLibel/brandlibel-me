...
export default function Privacy() {
    return (
        <div>
            ...
            <p>Under the Child's Online Privacy Security Act, no Website operator can require, as a condition to involvement in an activity, that a child younger than 13 years of age divulge more details than is reasonably required. BrandLibel abides by this demand. BrandLibel just collects information willingly offered; no information is gathered passively. In case BrandLibel collects and maintains personal information relating to a child under 13, the parent may send out an email to us to review, alter and/or erase such info as well as to decline to enable any additional collection or use of the child's information.</p>
